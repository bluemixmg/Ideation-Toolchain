...
public class Mensajes {
   ...
   //--------------------------------
   public static void Error(String mensaje, String CaptionWin){
       JOptionPane.showMessageDialog(null, mensaje, CaptionWin, JOptionPane.ERROR_MESSAGE);
   }
//--------------------------    
...
int res = JOptionPane.showOptionDialog(null, "Selecciona una Opcion", "Registrado",
