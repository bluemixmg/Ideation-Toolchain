...
public class ConexionCloudantBD {

	private static CloudantClient cloudant = null;
	private static Database db = null;

	private static String databaseName = "app_thinking";
	...
	private static void initClient() {
		if (cloudant == null) {
			synchronized (ConexionCloudantBD.class) {
				if (cloudant != null) {
					return;
				}
	...
	private static CloudantClient createClient() {
		...
		if (VCAP_SERVICES != null) {
			...
			throw new RuntimeException("VCAP_SERVICES No encontrado");
		}
		...
		try {
			...
			throw new RuntimeException("Inhabilitada para conectar al repositorio", e);
		}
	}
	...
	public static Database getDB() {
		...
		if (db == null) {
			try {
				...
				throw new RuntimeException("BD no encontrada", e);
			}
		}
		return db;
	}

	private ConexionCloudantBD() {
	}
}
